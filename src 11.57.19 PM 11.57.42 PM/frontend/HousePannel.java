 ...
 * @author sej
 */
public class HousePannel extends javax.swing.JPanel {

    /**
     * Creates new form house
     */
    City communityDir;
    public HousePannel(City communityDir) {
        initComponents();
...
public void updateCityTable() {
        ...
        for (int i = 0; i < community.houseList.size(); i++) {
            Object[] row = {City.state, community.houseList.get(i).cityName, community.houseList.get(i).communityName, community.houseList.get(i).houseNo};
            model.addRow(row);
        }
