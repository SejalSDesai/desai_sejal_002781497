...
public class EncounterPage extends javax.swing.JFrame {
    ...
    String community;
    int docId;
    public EncounterPage( EncounterHistory encHis,int docID,String username){
    initComponents();
    if(encHis == null){
            this.encounterhis = new EncounterHistory();
        }
        else{
...
//    }
    ...
    private void initComponents() {
        ...
        encpbodytemp = new javax.swing.JTextField();
        ...
        encpbodytemp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                encpbodytempActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(encpbodytemp, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel9)
                            .addComponent(encpbodytemp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(29, 29, 29)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void encpbodytempActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encpbodytempActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_encpbodytempActionPerformed
    ...
    private void viewbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewbtnActionPerformed
       ...
       encpatName.setText(selectedEnc.patient.per.getName());
        ...
        encpbodytemp.setText(String.valueOf(selectedEnc.getBodyTemperature()));
    ...
    private void createbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createbtnActionPerformed
       ...
       Encounter enc = new Encounter();
        boolean b1 = patientdirect.checkPID(Integer.parseInt(encpatId.getText()));
        boolean b2 = docdirect.checkDID(Integer.parseInt( encpatDocId.getText()));
        if(b1 && b2){
            ...
            enc.patient.setPatientId(Integer.parseInt(encpatId.getText()));
            enc.doc.setDocId(Integer.parseInt(encpatDocId.getText()));
    //        SimpleDateFormat encounterDate = new SimpleDateFormat("MMM-dd-yyyy");
            ...
            enc.patient.setName(encpatName.getText());
            enc.doc.setName(encpaDoctorName.getText());
            enc.setSugarlevel(Float.parseFloat(encpatSugarLevel.getText()));
            enc.setBloodPressure(Float.parseFloat(encpatBloodPressure.getText()));
            enc.setBodyTemperature(Float.parseFloat(encpbodytemp.getText()));
            enc.setSymptoms(encpatSymptons.getText());
            enc.setEncDiagnosis( encpatDiagnosis.getText());
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
        ...
        DefaultTableModel model1 = (DefaultTableModel) encounterRegistrationTable.getModel();
        Encounter selectedEnc=(Encounter)model1.getValueAt(selectedRowIndex1,0);
       selectedEnc.patient.setName(  encpatName.getText());
        selectedEnc.doc.setName(encpaDoctorName.getText());
        selectedEnc.setEncDate(DateChooser.getDate());
        selectedEnc.setEncTime(timePicker.getTime());
        selectedEnc.setBloodPressure(Float.parseFloat(encpatBloodPressure.getText()));
        selectedEnc.setSugarlevel(Float.parseFloat(encpatSugarLevel.getText()));
        selectedEnc.setBodyTemperature(Float.parseFloat(encpbodytemp.getText()));
        selectedEnc.setSymptoms(encpatSymptons.getText());
     selectedEnc.setEncDiagnosis(encpatDiagnosis.getText());
        encounterDispTable(docId);
    }//GEN-LAST:event_updatebtnActionPerformed
    public void encounterDispTable(int docId){
            DefaultTableModel model1 = (DefaultTableModel) encounterRegistrationTable.getModel();
    ...
    public void viewPatientDetails(String username){
        ...
        encpatName.setText(enc.patient.getName());
       encpatId.setText(String.valueOf( enc.patient.getPatientId()));
     encpatDocId.setText(String.valueOf(enc.doc.getDocId()));
       encpaDoctorName.setText(enc.doc.getName());
        encpatEncounterId.setText(String.valueOf(enc.getEncId()));
        DateChooser.setDate(enc.getEncDate());
        timePicker.setTime(enc.getEncTime());
        encpatBloodPressure.setText(String.valueOf(enc.getBloodPressure()));
        encpbodytemp.setText(String.valueOf(enc.getBodyTemperature()));
        encpatSugarLevel.setText(String.valueOf(enc.getSugarlevel()));
        encpatSymptons.setText(enc.getSymptoms());
       encpatDiagnosis.setText(enc.getEncDiagnosis());
...
//    }
    ...
    private javax.swing.JTextField encpbodytemp;
